...
data_dir = "../../../examples/nn_fwi/data/acoustic"
if !ispath(data_dir)
  mkpath(data_dir)
end
figure_dir = "../../../examples/nn_fwi/figure/FWI/marmousi/"
if !ispath(figure_dir)
  mkpath(figure_dir)
end
result_dir = "../../../examples/nn_fwi/result/FWI/marmousi/"
...
model_name = "../../../examples/nn_fwi/models/marmousi2-model-smooth.mat"
